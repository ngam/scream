...
// Fortran routines to be called from C++
  ...
  void grid_read_data_array_c2f_real(const char*&& filename, const char*&& varname, const Int hbuf_size, Real *&hbuf);
  void grid_read_data_array_c2f_int(const char*&& filename, const char*&& varname, const Int hbuf_size, Int *hbuf);
  void grid_read_data_array_wtime_c2f_real(const char*&& filename, const char*&& varname, const Int hbuf_size, Real *&hbuf, const Int time_level);
  void grid_read_data_array_wtime_c2f_int(const char*&& filename, const char*&& varname, const Int hbuf_size, Int *hbuf, const Int time_level);
...
void grid_read_data_array(const std::string &filename, const std::string &varname, const Int hbuf_size, Real* hbuf) {
  grid_read_data_array_c2f_real(filename.c_str(),varname.c_str(),hbuf_size,hbuf);
};
/* ----------------------------------------------------------------- */
...
void grid_read_data_array(const std::string &filename, const std::string &varname, const Int time_level, const Int hbuf_size, Real *hbuf) {
  grid_read_data_array_wtime_c2f_real(filename.c_str(),varname.c_str(),hbuf_size,hbuf,time_level);
};
/* ----------------------------------------------------------------- */
