...
!=====================================================================!
  subroutine grid_read_data_array_wtime_c2f_real(filename_in,varname_in,var_data_ptr,time_level) bind(c)
    use scream_scorpio_interface, only: grid_read_data_array

    type(c_ptr), intent(in)  :: filename_in
    type(c_ptr), intent(in)  :: varname_in
    type(c_ptr), intent(out) :: var_data_ptr
    ...
    call convert_c_string(filename_in,filename)
    call convert_c_string(varname_in,varname)
    call grid_read_data_array(filename,varname,var_data_ptr,time_level)
