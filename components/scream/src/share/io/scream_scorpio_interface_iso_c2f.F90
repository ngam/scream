...
!=====================================================================!
  subroutine grid_read_data_array_c2f_real(filename_in,varname_in,var_size,var_data_ptr) bind(c)
    ...
    real(kind=c_real), dimension(var_size) :: var_data
    ...
    call convert_c_string(filename_in,filename)
    call convert_c_string(varname_in,varname)
    call grid_read_data_array(filename,varname,var_size,var_data)
    write(*,*) " c2f - ", trim(varname), ", ", var_size, ": ", var_data
...
!=====================================================================!
  subroutine grid_read_data_array_c2f_int(filename_in,varname_in,var_size,var_data_ptr) bind(c)
    ...
    type(c_ptr), intent(in)                               :: varname_in
    integer(kind=c_int), value, intent(in)                :: var_size
    integer(kind=c_int), dimension(var_size), intent(out) :: var_data_ptr
...
!=====================================================================!
  subroutine grid_read_data_array_wtime_c2f_real(filename_in,varname_in,var_size,var_data_ptr,time_level) bind(c)
    use scream_scorpio_interface, only: grid_read_data_array

    type(c_ptr), intent(in)                             :: filename_in
    type(c_ptr), intent(in)                             :: varname_in
    integer(kind=c_int), value, intent(in)              :: var_size
    real(kind=c_real), intent(out), dimension(var_size) :: var_data_ptr
    integer(kind=c_int), value, intent(in)              :: time_level
    ...
    call convert_c_string(filename_in,filename)
    call convert_c_string(varname_in,varname)
    call grid_read_data_array(filename,varname,var_size,var_data_ptr,time_level)

  end subroutine grid_read_data_array_wtime_c2f_real
!=====================================================================!
  subroutine grid_read_data_array_wtime_c2f_int(filename_in,varname_in,var_size,var_data_ptr,time_level) bind(c)
    use scream_scorpio_interface, only: grid_read_data_array
  ...
  end subroutine grid_read_data_array_wtime_c2f_int
!=====================================================================!
